...
urlpatterns = [
    ...
    path('dictionaries/get-types/', DictionariesView.as_view({'get': 'get_brands'}), name='get-brands'),
    path('dictionaries/get-models/', DictionariesView.as_view({'get': 'get_models'}), name='get-models'),
    path('dictionaries/get-colors/', DictionariesView.as_view({'get': 'get_body_types'}), name='get-boty-types'),
