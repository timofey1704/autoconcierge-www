...
const GetSubscription = () => {
  ...
  return (
    ...
    >
      <div className="relative md:w-180 lg:w-240 xl:w-304 h-120 xl:h-118.75 overflow-hidden rounded-[40px]">
        ...
        <div className="relative flex flex-col justify-start z-10 w-full h-full px-4 sm:px-6 md:px-15 py-10 md:py-15">
          <FormProvider>
            <form
            ...
            >
              ...
              <p className="w-full sm:w-78 pt-2.5 pb-5 text-white xl:w-115 xl:pt-5 xl:pb-8">
              ...
              <div className="flex w-full flex-wrap items-end gap-5 pb-5">
                <UTextInput
                  ...
                  className="phone-input min-w-64 sm:min-w-75"
                />

                <UButton text="Защитить автомобиль" className="max-w-64 sm:max-w-75 lg:min-w-75" type="submit" />
              </div>
              <div className="flex w-full sm:w-56 md:w-full items-center gap-2.5">
                <UCheckbox
                  name="privacy_policy"
                  handleChange={handleChange}
